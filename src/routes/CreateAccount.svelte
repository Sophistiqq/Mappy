<script lang="ts">
  ...
  import { UserPlus, User, Lock, Mail, AlertCircle } from "lucide-svelte";
...
<div class="login-container">
  <div class="login-card">
    ...
    <div class="footer-links">
      <span class="link-btn" style="cursor: default;">Already have an account?</span>
      <button type="button" class="link-btn" onclick={() => navigate('/login')}>Sign in</button>
    </div>
  </div>
</div>
